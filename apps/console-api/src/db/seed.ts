...
const REGISTRATIONS: readonly RegSeed[] = [
	...
	},
	{
		...
		prefixes: ["agent.heartbeat", "agent.crashed", "agent.lifecycle", "channel"],
		scopes: ["fleet", "agent:*"],
		maxSeverity: "p0",
	},
	{
	...
	},
	{
		...
		prefixes: ["governance", "fleet.mode", "discipline", "usage"],
		scopes: ["fleet", "agent:*"],
		maxSeverity: "warn",
	},
	{
		...
		services: ["bridge"],
		prefixes: ["host", "container", "box", "service.lifecycle"],
		scopes: ["fleet"],
		maxSeverity: "p0",
	},
];
