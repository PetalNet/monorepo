...
/// and a "· 4m" last-updated line; no fix yet ⇒ they stay listed but locationless
/// (an accepted-but-not-yet-located, or dark, person — plotted by neither).
Person mergePresence(Person p, PeerFix? fix, {DateTime? now}) {
...
final peopleWithPresenceProvider = Provider<List<Person>>((ref) {
  ...
  return [for (final p in people) mergePresence(p, live[p.userId])];
});
