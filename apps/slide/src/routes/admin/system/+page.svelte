...
<PageContainer>
	<PageHeader title="System Information" subtitle="Server process and memory details" />

	<!-- Process Info -->
	<div class="mb-6 rounded-lg bg-white p-6 shadow">
		<h2 class="mb-4 text-lg font-semibold text-gray-900">Process Information</h2>
	...
	<!-- Memory Usage -->
	<div class="mb-6 rounded-lg bg-white p-6 shadow">
		<h2 class="mb-4 text-lg font-semibold text-gray-900">Memory Usage</h2>

		<div class="mb-6">
			<h3 class="mb-2 text-sm font-medium text-gray-700">Process Memory</h3>
			<div class="space-y-2">
				<div>
					<div class="mb-1 flex justify-between text-sm">
						<span class="text-gray-600">Heap Used</span>
						<span class="font-medium"
							>{formatBytes(data.process.memory.heapUsed)} / {formatBytes(
		...
		<div>
			<h3 class="mb-2 text-sm font-medium text-gray-700">System Memory</h3>
			<div>
				<div class="mb-1 flex justify-between text-sm">
					<span class="text-gray-600">Used</span>
					<span class="font-medium">
						{formatBytes(data.system.memory.total - data.system.memory.free)} / {formatBytes(
	...
	<div class="rounded-lg bg-white p-6 shadow">
		<h2 class="mb-4 text-lg font-semibold text-gray-900">Environment</h2>
		<dl class="space-y-3">
			<div class="flex justify-between">
				<dt class="text-sm text-gray-500">NODE_ENV</dt>
				<dd class="text-sm font-medium text-gray-900">
					<span
						class="rounded px-2 py-1 {data.environment.nodeEnv === 'production'
			...
			<div class="flex justify-between">
				...
				<dd class="ml-4 truncate font-mono text-xs font-medium text-gray-900">
