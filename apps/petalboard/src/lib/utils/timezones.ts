...
/**
 * Converts a datetime-local input string (YYYY-MM-DDTHH:mm) to a UTC Date interpreting the local
 * time in the specified timezone.
 *
 * For example, if dateTimeString is "2025-11-03T17:00" and timezone is "America/Chicago", this
 * returns a Date representing 2025-11-03 17:00 CST in UTC (which would be 23:00 UTC).
 *
...
/**
 * Converts a UTC Date to a datetime-local input string (YYYY-MM-DDTHH:mm) displaying the time in
 * the specified timezone.
 *
 * For example, if the date is "2025-11-03T23:00:00Z" (UTC) and timezone is "America/Chicago", this
 * returns "2025-11-03T17:00" (5pm CST).
 *
