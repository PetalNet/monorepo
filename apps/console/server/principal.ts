...
export const principalResolver = (services: Services) => async (request: IncomingMessage): Promise<Principal | null> => {
	...
	return { kind: "human", id, tiers: [tier], lanes: [...lanes[tier]], scopes: resolved.scopes, zookie: resolved.zookie };
};
