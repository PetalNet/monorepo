...
void test("the op-name union covers exactly the canonical catalog", () => {
...
void test("every canonical op has metadata and a valid fixture", () => {
...
void test("the validators reject incompatible contract payloads", () => {
...
void test("server->client validation ignores unknown keys (open shapes)", () => {
...
void test("every API fixture validates against its Effect Schema", () => {
