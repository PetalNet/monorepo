/**
 * GENERATED by scripts/generate-contracts.mjs from console-api/docs/contracts/ops.json. Wire
 * metadata and argument schemas are canonical; only button verbs are UI-owned.
 */
			...
			properties: {
				...
				time: {
					...
					properties: {
						...
						fill: {
							enum: ["none", "null", "zero", "previous", null],
						},
						coverage: {
							type: "boolean",
						},
