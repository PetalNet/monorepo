...
<section
	...
	aria-label="Library manager session"
>
	<header>
		...
		<span class="state"
			>{connected ? (sessionId ? "session live" : "ready on first ask") : "unreachable"}</span
		>
	</header>
	...
	<div class="hint">
		<kbd>/</kbd> ask · <kbd>f</kbd> literal search · ask the manager to change views or curate the reading
		room
	</div>
</section>
