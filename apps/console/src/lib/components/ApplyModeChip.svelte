<script lang="ts">
	...
	/**
	 * ApplyModeChip (09-updates §3.3): a READ-ONLY chip, deliberately not a control. Apply mode is
	 * agent-malleable (/task/711) — you ask Janet to change it, there is no settings maze. Focusable
