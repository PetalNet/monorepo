...
- **Status:** Superseded by [Unified SvelteKit console substrate](adr/UNIFIED-SVELTEKIT-CONSOLE.md)
- **Date:** 2026-07-13
...
> This ADR records the former separate-service decision. It is retained for history only. The
> gateway is now folded into `apps/console`; no `apps/console-api` deployment boundary remains.
